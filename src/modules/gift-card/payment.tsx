...
const APPLICATION_ID = 'sandbox-sq0idb-vPn0SbXDf4WCiVmdO-SyPg';
const LOCATION_ID = 'LWA03MEVCXBXY';
...
const PaymentPage = () => {
  ...
  function cardNonceResponseReceived(errors, nonce, cardData, buyerVerificationToken) {
    ...
    alert('nonce created: ' + nonce + ', buyerVerificationToken: ' + buyerVerificationToken + ', cardDataL ' + cardData);
