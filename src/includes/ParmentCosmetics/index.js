...
class Parment extends Component {
    ...
    render() {
        return <Container style={{ paddingTop: 100, marginBottom: 200 }}>
            ...
            <Body imgUrl="https://belmontbeautysalon.com/wp-content/uploads/2018/11/4.jpg" top={70} reverse={true} text="Permanent makeup is a cosmetic technique which employs tattoos (permanent pigmentation of the dermis) as a means of producing designs that resemble makeup,such as lips." />
